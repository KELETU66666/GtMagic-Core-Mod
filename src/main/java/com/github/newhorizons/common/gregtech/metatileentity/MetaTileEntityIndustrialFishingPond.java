...
import static com.github.newhorizons.common.gregtech.metablock.GTMMetaCasing.MetalCasingType.FISHING_CASING;
...
public class MetaTileEntityIndustrialFishingPond extends MultiblockWithDisplayBase implements IWorkable, IDataInfoProvider {
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        return GTMTextures.FISHING_CASING;
    }
    ...
    protected IBlockState getCasingState() {
        return GTMMetaBlocks.GTM_BLOCK_CASING.getState(FISHING_CASING);
    }
